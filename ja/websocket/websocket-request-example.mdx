---
title: 'WebSocket リクエスト例'
description: '本ページでは、AllTick WebSocket相場APIのリクエスト例コードを提供します。WebSocket接続の確立、購読リクエストの送信、ハートビート処理、リアルタイムプッシュメッセージの処理方法を示し、多言語サンプルも掲載します。開発者がストリーミング方式で為替、株式、暗号資産などの市場のリアルタイムTickと板情報を購読できるよう支援します。'
keywords: ["AllTick WebSocketリクエスト例","相場プッシュ購読","WebSocket相場API demo","リアルタイムTickストリーミングデータ","ハートビートと購読サンプルコード","リアルタイム板情報プッシュ"]
---
