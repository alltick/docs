...
description: 'このインターフェースは、世界主要取引所（SSE、NYSE、NASDAQ）の売買停止・再開情報照会を提供します。すべてのインターフェースはJSONデータを返し、公告時刻の降順で並びます。'
keywords: ["GET 売買停止・再開情報照会インターフェース","AllTick API","HTTP API","WebSocket API","リアルタイム相場","株式相場","金融データ","クオンツ取引"]
---
## GET /api/suspension
