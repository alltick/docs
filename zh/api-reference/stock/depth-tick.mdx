...
description: '本接口文档介绍AllTick股票HTTP接口中的“GET 最新盘口报价查询”API，可查询美股、港股、A股等股票的最新盘口报价，包括买一卖一、多档买卖盘和盘口深度信息，并给出请求URL、参数说明、返回字段格式和频率限制，适合量化交易、做市系统和行情终端接入实时订单簿数据。'
keywords: ["AllTick最新盘口报价","股票盘口深度API","买卖盘HTTP接口","实时订单簿数据","美股港股A股盘口","depth-tick文档","量化交易盘口数据"]
---
## GET /depth-tick
...
* 完整URL: <a href="https://quote.alltick.co/quote-stock-b-api/depth-tick">https://quote.alltick.co/quote-stock-b-api/depth-tick</a>

**2、外汇、贵金属、加密货币、原油、CFD指数、商品接口地址：**

* 基本路径: /quote-b-api/depth-tick
* 完整URL: <a href="https://quote.alltick.co/quote-b-api/depth-tick">https://quote.alltick.co/quote-b-api/depth-tick</a>
...
<Card title="打开 GET /depth-tick 调试模块" icon="play" href="/zh/api-reference/stock/debug/depth-tick">
  使用可调试模块填写参数并发送请求。
</Card>
