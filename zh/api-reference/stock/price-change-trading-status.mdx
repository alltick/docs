...
description: 'Alltick的接口不提供涨跌幅或24小时涨跌幅字段。客户可以通过获取Alltick的数据自行计算涨跌幅。'
keywords: ["涨跌幅、休市、假期、涨停跌停、新股上市和退市","AllTick API","HTTP API","WebSocket API","实时行情","股票行情","金融数据","量化交易"]
---
## 涨跌幅说明
...
Alltick并未提供休市或交易时间的接口。客户可以通过[【产品列表】](https://docs.google.com/spreadsheets/d/1avkeR1heZSj6gXIkDeBt8X3nv4EzJetw4yFuKjSDYtA/edit?gid=495387863#gid=495387863)查看各类产品的固定交易时间。

[【产品列表】](https://docs.google.com/spreadsheets/d/1avkeR1heZSj6gXIkDeBt8X3nv4EzJetw4yFuKjSDYtA/edit?gid=495387863#gid=495387863)

## 假期说明

Alltick不提供假期接口。假期休市通知将提前在我们的Telegram频道发布，具体休市的产品信息请以Telegram频道的通知为准。请及时关注频道以获取假期休市的最新通知。
...
<img src="/images/stock-limit-up-down.png" alt="股票涨停跌停判断示例" width="563" />
...
<img src="/images/stock-delisted.png" alt="股票退市判断示例" width="563" />
