---
title: 'How do I report data issues or API malfunctions?'
description: 'This FAQ answers How do I report data issues or API malfunctions?, covering common questions about AllTick API usage, subscriptions, account management, data quality and technical integration.'
keywords: ["AllTick API","How do I report data issues or API malfunctions?","real-time market data API","stock market data","WebSocket quotes","HTTP API documentation","quant trading data","financial data integration"]
---
\
