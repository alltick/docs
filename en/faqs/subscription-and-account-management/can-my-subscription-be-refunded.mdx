---
title: 'Can my subscription be refunded?'
description: 'This FAQ answers Can my subscription be refunded?, covering common questions about AllTick API usage, subscriptions, account management, data quality and technical integration.'
keywords: ["AllTick API","Can my subscription be refunded?","real-time market data API","stock market data","WebSocket quotes","HTTP API documentation","quant trading data","financial data integration"]
---
